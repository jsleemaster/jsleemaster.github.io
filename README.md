...
| <img src="https://opengraph.githubassets.com/1/jsleemaster/drink_up" alt="꿀꺽 icon" width="18" height="18" /> 꿀꺽 | 수분 섭취 트래킹 및 소셜 챌린지 기능을 제공하는 웹 서비스 (토스 앱인토스 프로젝트) | React, TypeScript, Vite, Cloudflare Workers, Cloudflare KV | <a href="https://minion.toss.im/nmqdGkN2" target="_blank" rel="noopener noreferrer">🌐 Web</a> |
